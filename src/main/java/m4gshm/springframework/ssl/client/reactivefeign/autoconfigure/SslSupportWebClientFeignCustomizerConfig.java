...
public class SslSupportWebClientFeignCustomizerConfig {
    ...
    public WebClientFeignCustomizer sslSupportWebClientFeignCustomizer(
            m4gshm.springframework.ssl.client.reactivefeign.ReactiveFeignHttpClientProperties properties, ObjectProvider<NettySslContextBuilderFactory> sslContextBuilderFactory) {
